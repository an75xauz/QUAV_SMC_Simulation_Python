...
def load_model(actor_path, device, state_dim=16, action_dim=4, hidden_sizes=[256, 256]):
    """
    載入訓練好的 Actor 模型
...
def main():
    ...
    parser.add_argument(
        '--target', type=float, nargs=3, default=[1, 3, 2],
    ...
    parser.add_argument(
        '--actor_file', type=str, default='actor_final.pth',
